...
export default async function OutdoorFurniture() {
  const products = await client.fetch(
    `*[_type == "product" && category == "outdoor & tropical furniture"]{
      title,
      price,
      description,
      productImage {
  ...
  return (
    ...
    <div className="p-4">
      {/* Centered Heading */}
      <h1 className="text-3xl font-bold text-center  mt-10 mb-6">Outdoor & Tropical Furniture</h1>
